...
class OrderPechatDoctor extends React.Component {
    state = {
        formEnabled: false,
        sampleImages: '',
        chosenImage: '',
    ...
    loadImages = (event) => {
      const samples = sampleItems.pechat_doctor[event.target.selectedIndex];
        ...
        return (
            <React.Fragment>
                <form>
                    <div className="row">
                        <div className="col">
                            <h3 className="text-center">Форма заказа печати врача</h3>          
                        </div>
                    </div>
                    <div className="row my-2">
                        ...
                        <label htmlFor="orgForm" className="col-form-label">
                            Врач <br/> 
                            <small>(ФИО полностью как в документах)</small>
                        </label>
                        </div>
                        <div className="col-md-8">
                            <input className="form-control" name="doctorFio" />
                            <input type="Hidden" name="orgForm" defaultValue="" />
                            <input type="Hidden" name="otherOrgForm" defaultValue="" />		
                            <input type="hidden" defaultValue="" name="orgName" />
                    ...
                    <div className="row my-2">
                        ...
                        <label htmlFor="orgPlace" className="col-form-label">
                            Место нахождения 
                            <small>(по желанию, например: Россия, г. Новосибирск) </small>
                        </label>
                        </div>
                        <div className="col-md-8">
                        <input type="text" defaultValue="" className="form-control" name="orgPlace" />
                        </div>
                    </div>
            ...
            <div className="row my-2">
                ...
                <div className="col-md-6">
                    <select className="form-control" onChange={ this.loadImages }>
                                <option defaultValue="1">Диаметром 28 мм</option>
                                <option defaultValue="2">Диаметром 38 мм</option>
                                <option defaultValue="3">Диаметром 38 и с защитой от подделки</option>
                    </select>
                    <br/>
            ...
            <div className="row my-5">
                ...
                <div className="row">
                    ...
                    <div className="col-md-6 col text-center">
                        <label className="col-form-label d-block">
                        <input type="Radio" name="diameter" ref={ this.diameter1 }  onClick={ this.culc } defaultValue="28" />
                        <br/>
                        28 мм</label>
                    </div>
                </div>
...
export default OrderPechatDoctor;