...
class OrderPechatGerb extends React.Component {
    state = {
        formEnabled: false,
        sampleImages: '',
        chosenImage: '',
    ...
    loadImages = (event) => {
      const samples = sampleItems.pechat_gerb[event.target.selectedIndex];
            ...
            <React.Fragment>
                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <label className="col-form-label">
                                Требуется печать
                                с изображением</label> 
                        </div>
                        <div className="col-md-8">
                            <div className="row">
                                <div className="col text-center">
                                <label>
                                    <img src="img/samples/gerbgos.png" alt="" width="51" height="53" border="0" /><br/>
                                    Государственного герба <br/>
                                    <input type="Radio" name="imgType"  defaultValue="gosgerb" defaultChecked />
                                </label>
                                </div>
                                <div className="col text-center">
                                <label>
                                    <img src="img/samples/gerbnso.png" alt="" width="51" height="53" border="0" /><br/>
                                    Герба <br/> НСО <br/>
                                    <input type="Radio" name="imgType" defaultValue="nsogerb" />
                                </label>
                                </div>
                                <div className="col text-center">
                                <label>
                                    <img src="img/samples/gerbgorod.png" alt="" width="51" height="53" border="0" /><br/>
                                    Герба г. Новосибирска <br/>
                                    <input type="Radio" name="imgType" defaultValue="citygerb" />
                                </label>
                                </div>
                                <div className="col text-center" style={{paddingTop: '53px'}}>
                                <label>
                                    Герба иного <br/> субъекта <br/>
                                    <input type="Radio" name="imgType" defaultValue="othergerb" />
                                </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row my-2">
                        ...
                        <label htmlFor="orgForm" className="col-form-label">
                            ...
                            <small>(Если нет, то полное)</small>
                        </label>
                        </div>
                        <div className="col-md-8">
                            <input type="text" className="txtInput form-control" name="upperOrg" />  
                            <input type="hidden" value="" name="orgForm" />	
                        </div>
                    </div>
                    <div className="row my-2">
                        <div className="col-md-4">
                        <label htmlFor="orgPlace" className="col-form-label">
                                Полное наименование
                                юридического лица 
                                <small>(организации) как в свидетельстве и в учредительных документах</small>
                        </label>
                        </div>
                        <div className="col-md-8">
                    ...
                    <div className="row my-2">
                            ...
                            <label htmlFor="orgPlace" className="col-form-label">
                                Краткое наименование 
                                    <small>(если имеется и указано в учредительных документах)</small>
                            </label>
                            </div>
                            <div className="col-md-8">
                            <input type="text" className="txtInput form-control" name="shortOrgName" />
                            </div>
                        </div>
                    <div className="row my-2">
                        <div className="col-4">
                        <label htmlFor="ogrn" className="col-form-label">ОГРН
                            <small> (из свидетельства, по желанию)</small>
                        </label>
                        </div>
                        <div className="col-8">
                        <input type="text" defaultValue="" className="form-control" name="ogrn" />
                        </div>
                    </div>
                    <div className="row my-2">
                        <div className="col-4">
                        <label htmlFor="inn" className="col-form-label">ИНН
                            <small> (из свидетельства, по желанию)</small>
                        </label>
                        </div>
                        <div className="col-8">
                           ...
                           <div className="row my-2">
                                ...
                                <div className="col-md-6">
                                    <select className="form-control" onChange={ this.loadImages }>
                                        <option value="1">Печти с изображением герба РФ</option>
                                        <option value="2">Печати с изображением герба г. Новосибирска и НСО</option>
                                    </select>
                                    <br/>
            ...
            <div className="row">
                ...
                <div className="row">
                    <div className="col-md-4 col text-center">
                        ...
                        <input type="Radio" name="diameter" ref={ this.diameter0 } onClick={ this.culc } defaultValue="40" defaultChecked />
                        <br/>
                        40 мм</label>
                    </div>
                    <div className="col-md-4 col text-center">
                        <label className="col-form-label d-block">
                    <input type="Radio" name="diameter" ref={ this.diameter1 }  onClick={ this.culc } defaultValue="42" />
                    <br/>
                    42 мм</label>
                    </div>
                    <div className="col-md-4 col text-center">
                    <label className="col-form-label d-block">
                    <input type="Radio" name="diameter" ref={ this.diameter2 }  onClick={ this.culc } defaultValue="45" />
                    <br/>
                    45 мм</label>
                    </div>
                </div>
...
export default OrderPechatGerb;