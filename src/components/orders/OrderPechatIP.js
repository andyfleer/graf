...
class OrderPechatIP extends React.Component {
    state = {
        formEnabled: false,
        sampleImages: '',
        chosenImage: '',
    ...
    loadImages = (event) => {
      const samples = sampleItems.pechat_ip[event.target.selectedIndex];
                ...
                <div className="row">
                    <div className="col">
                        <h3 className="text-center">
                            Форма заказа печати индивидуального предпринимателя  
                        </h3>          
                    </div>
                </div>
                <div className="row my-2">
                    <div className="col-md-4">
                        <label htmlFor="orgForm" className="col-form-label">
                            Индивидуальный<br/>предприниматель<br/>
        ...
        <div className="row my-2">
                ...
                <div className="col-md-6">
                    <select className="form-control" onChange={ this.loadImages }>
                        <option value="1">Текстовая печать</option>
                        <option value="2">Печать с рисунком</option>
                        <option value="3">Печать с защитой</option>
                        <option value="4">Специальная печать</option>
                    </select>
                    <br/>
