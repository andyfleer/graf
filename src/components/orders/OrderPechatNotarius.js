...
class OrderPechatNotarius extends React.Component {
    state = {
        formEnabled: false,
        sampleImages: '',
        chosenImage: '',
        ...
        return (
            <React.Fragment>
                ...
                <div className="row my-2">
                    ...
                    <label htmlFor="orgForm" className="col-form-label">
                        Нотариус
                        ФИО полностью 
                        <small>(как в документах)</small>
                    </label>
                    </div>
                    <div className="col-md-8">
                        <input type="text" className="form-control" name="notariusFio" />
                ...
                <div className="row my-2">
                    ...
                    <label htmlFor="orgPlace" className="col-form-label">
                        Наименование нотариального округа<br/>
                            <small>(например, г. Новосибирск)</small>
                    </label>
                    </div>
                    <div className="col-md-8">
                        <input className="form-control" name="okrug" />
                    </div>
                </div>
                <div className="row my-2">
                    <div className="col-4">
                ...
                <div className="row my-2">
                    ...
                    <div className="col-md-6">
                        <div id="imagesOutput">
                            <img src="img/samples/377899496.png" alt="" className="img-sample" onClick={ () => this.showChosenImg('377899496.png','190','1300') } />
                            <img src="img/samples/841676409.png" alt="" className="img-sample" onClick={ () => this.showChosenImg('841676409.png','191','1300') } />
                        </div>
                    </div>
                    </div>
            ...
            <div className="row">
                ...
                <div className="row">
                    ...
                    <div className="col-md-4 col text-center">
                        <label className="col-form-label d-block">
                    <input type="Radio" name="diameter" ref={ this.diameter1 }  onClick={ this.culc } defaultValue="43" />
                    <br/>
                    43 мм</label>
                    </div>
                    <div className="col-md-4 col text-center">
...
export default OrderPechatNotarius;