...
class OrderPechatPersonal extends React.Component {
    state = {
        formEnabled: false,
        sampleImages: '',
        chosenImage: '',
...
showChosenImg = (chosenImage, sampleId, samplePrice) => {
    ...
    render() {
        return (
            ...
            <div className="row my-2">
                <div className="col-md-4">
                <label className="col-form-label">Текст 2-ой окружности
                </label>
                </div>
                <div className="col-md-8">
                    <input type="text" name="second" defaultValue="" className="form-control" />
                </div>
            </div>
            <div className="row my-2">
                <div className="col-md-4">
                <label className="col-form-label">Текст в центре круга</label>
                </div>
                <div className="col-md-8">
                    <input type="text" defaultValue="" className="form-control" name="center" />
                </div>
            </div>
            ...
            <div className="row my-2">
                ...
                <div className="col-md-2 text-center">
                    ...
                    <input type="hidden" id="pr" defaultValue={this.state.samplePrice} />
                    <img  src={ `img/samples/${this.state.chosenImage}` } className="chosen-img" alt="" id="chosen-sample-img"  />
                </div>
                <div className="col-md-6">
                    <div id="imagesOutput">
                        <img src="img/samples/1790880933.png" alt="" width="100" onClick={ () => this.showChosenImg('1790880933.png','120','600') } />
                        <img src="img/samples/855955869.png" alt="" width="100" onClick={ () => this.showChosenImg('855955869.png','123','600') } />
                        <img src="img/samples/1212550233.png" alt="" width="100" onClick={ () => this.showChosenImg('1212550233.png','126','500') } />
                        <img src="img/samples/1983322547.png" alt="" width="100" onClick={ () => this.showChosenImg('1983322547.png','121','600') } />
                        <img src="img/samples/236695792.png" alt="" width="100" onClick={ () => this.showChosenImg('236695792.png','124','400') } />
                        <img src="img/samples/1922011517.png" alt="" width="100" onClick={ () => this.showChosenImg('1922011517.png','127','600') } />
                        <img src="img/samples/1509141591.png" alt="" width="100" onClick={ () => this.showChosenImg('1509141591.png','122','600') } />
                        <img src="img/samples/1180760827.png" alt="" width="100" onClick={ () => this.showChosenImg('1180760827.png','125','400') } />
                        <img src="img/samples/55300755.png" alt="" width="100" onClick={ () => this.showChosenImg('55300755.png','128','400') } />
                    </div>
                </div>
            </div>
            ...
            <div className="row my-5">
                ...
                <div className="row">
                    <div className="col-md-3 col text-center">
                        ...
                        <input type="Radio" name="diameter" ref={ this.diameter0 } onClick={ this.culc } defaultValue="38-40" defaultChecked />
                        <br/>
                        38-40 мм</label>
                    </div>
                    <div className="col-md-3 col text-center">
                        <label className="col-form-label d-block">
                        <input type="Radio" name="diameter" ref={ this.diameter1 }  onClick={ this.culc } defaultValue="45" />
                        <br/>
                        45 мм</label>
                    </div>
                    <div className="col-md-3 col text-center">
...
export default OrderPechatPersonal;